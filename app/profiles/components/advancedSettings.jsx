...
export default function AdvancedProfileQuerySettings(props) {
    const { setQueryFilter = noop, filterProfiles = noop } = props;
                ...
                <div className="flex gap-4">
                    ...
                    <div className="w-full m-auto mb-4">
                        ...
                        <TextInput
                            ...
                            id={`paramValue${index}`}
                            placeholder="Ex: parentOrganization eq '102202'"
                            value={paramValue}
