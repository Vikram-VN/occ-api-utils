    ...
    <React.Fragment>
      ...
      <div className="inline-flex ml-1 flex-col tablet:flex-row">
        <div className="w-full">
          <h1 className="mt-10 mb-4 text-4xl text-start bold ">Oracle Commerce</h1>
        ...
        <div className="w-full">
          <h1 className="mt-10 mb-4 text-4xl text-start bold  pr-5">About the REST APIs</h1>
      ...
      <div className="inline-flex gap-x-20 flex-col tablet:flex-row">
        <div className="primary w-full pr-1 text-start">
          <h1 className="mt-10 mb-4 text-4xl  text-start bold">About Commerce API Utils</h1>
