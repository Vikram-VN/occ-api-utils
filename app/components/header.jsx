...
const Header = () => {
  return (
      <header>
        <nav className="bg-white border-slate-200 px-4 lg:px-6 py-2.5 dark:bg-slate-900 fixed top-0 w-full">
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
            <Link href="https://apexit.com" className="flex items-center">
              <Image src="/apexit-white.png" className="mr-3 h-20 sm:h-10 md:h-20"  width={100} height={100} alt="ApexIT" />
              <span className="self-center text-3xl font-semibold whitespace-nowrap dark:text-white">Commerce API Utils</span>
            </Link>
            <div className="flex items-center lg:order-2">
              ...
              <Link href="https://github.com/Vikram-VN/occ-api-utils" className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">GitHub</Link>
              <button data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-slate-500 rounded-lg lg:hidden hover:bg-slate-100 focus:outline-none focus:ring-2 focus:ring-slate-200 dark:text-slate-400 dark:hover:bg-slate-700 dark:focus:ring-slate-600" aria-controls="mobile-menu-2" aria-expanded="false">
