   ...
   return (
      <div className="flex bg-slate-100 dark:bg-slate-800">
         <div className="h-full mt-6">
            ...
            {isLoggedIn && <React.Fragment> <Tooltip content="Deployment" placement="auto" className="z-20">
               ...
               <Tooltip content="Item Types" placement="auto" className="z-20">
                  <Link href="/items" className="h-10 mr-4 flex items-center p-2 mt-2 ml-3 text-sm text-slate-900 rounded-lg dark:text-white hover:bg-slate-100 dark:hover:bg-slate-700">
                     <CubeIcon className="w-6 h-6 text-slate-600 transition duration-75 dark:text-slate-400 group-hover:text-slate-900 dark:group-hover:text-white" fill="currentColor" stroke="currentColor" />
