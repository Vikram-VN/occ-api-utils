...
const Footer = () => {
    return (
        <footer className="p-4 bg-white sm:p-6 dark:bg-slate-900 relative bottom-0 border-t dark:border-t-slate-600">
            <div className="mx-auto max-w-screen-xl">
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    ...
                    <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                        ...
                        <Link href="https://github.com/Vikram-VN/occ-api-utils" className="text-slate-500 hover:text-slate-900 dark:hover:text-white">
