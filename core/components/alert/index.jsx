  ...
  return (
    <React.Fragment>
      ...
      <div className="flex">
        ...
        <button
          type="button"
          className="rounded-lg border border-yellow-700 bg-transparent px-3 py-1.5 text-center text-xs font-medium text-yellow-700 hover:bg-yellow-800 hover:text-white focus:ring-4 focus:ring-yellow-300 dark:border-yellow-800 dark:text-yellow-800 dark:hover:text-white"
          onClick={onDismiss}
        >
          Dismiss
        </button>
...
const Alert = (props) => {
  return (
    <AlertComponent
      ...
      {...props}
    >
      <span className="font-medium">{props.message || "Alert message"}</span>
    </AlertComponent>
  );
};
...
export const AlertInfo = (props) => {
  return (
    <AlertComponent
      ...
      rounded={true}
      withBorderAccent={true}
      additionalContent={showInfoMessage(
        props.color,
        props.infoMessage,
        props.onDismiss,
        props.link,
